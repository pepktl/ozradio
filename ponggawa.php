					...
					<div class="slider">
                        <div class="slText" style="z-index: 5; position: absolute;">
                                ...
                                <h1 class="slider-txt" style="z-index: 5;">
                                    <span id="teks1" style="display: block;">PONGGAWA</span> 
                                 </h1>
            ...
            <div>
                <div class="row">
                    <div class="col-md-12" style="height: 760px;">
                        ...
                        <!-- Left Item -->
                            <div class="col-md-3 col-md-offset-3" style="width: 320px; right: 160px; margin-top: 250px;">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                            	<ul class="ponggawa-ul list-unstyled">
						    		
						    		<li class="ponggawa-list">
						    			<a data-toggle="modal" href="#myModal1"><img src="images/pong/190/an.jpg"></a>
